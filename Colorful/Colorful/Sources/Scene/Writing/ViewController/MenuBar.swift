...
protocol MenuBarDelegagte: class {
    func menuBarView(scrollTo index: Int)
}

class MenuBarView: UIView {
    
    weak var delegate: MenuBarDelegagte?
    ...
    func setupCollectioView(){
        ...
        customTabBarCollectionView.register(UINib(nibName: "CustomCell", bundle: nil), forCellWithReuseIdentifier: "CustomCell")
...
extension MenuBarView: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        delegate?.menuBarView(scrollTo: indexPath.row)
    }
...
extension MenuBarView: UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, insetForSectionAt section: Int) -> UIEdgeInsets {
        return UIEdgeInsets(top: 0, left: 77, bottom: 0, right: 50)
    }
